...
import { ArrowLeft, Loader2, User, Newspaper, Shield } from "lucide-react";
...
const ROLES = [
  {
    value: "CITIZEN",
    label: "Ciudadano",
    description: "Reportar y votar incidencias",
    icon: User,
  },
  {
    value: "JOURNALIST",
    label: "Periodista",
    description: "Investigar y publicar contenido",
    icon: Newspaper,
  },
  {
    value: "MODERATOR",
    label: "Moderador",
    description: "Validar y gestionar incidencias",
    icon: Shield,
  },
];
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-[440px]">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-[22px] font-semibold">Únete a tu comunidad</h2>
        </div>
